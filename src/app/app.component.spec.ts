...
describe('AppComponent', () => {
  ...
  describe('Pagination', () => {
    beforeEach(() => {
      booksService.searchBooks.and.returnValue(of({ items: mockBooks, totalItems: 20 }));
      component.books = mockBooks;
      component.booksLength = 20;
    ...
    it('should set isLoadingResult to true when navigating', fakeAsync(() => {
      component.booksLength = 20;
      component.nextBtn();
      expect(component.currentIndex).toEqual(20);
      tick();
